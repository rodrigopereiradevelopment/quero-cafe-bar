...
const mesas = [
  // === BAR/BALCAO (8 cadeiras lado a lado) ===
  { qtd_cadeiras: 1, numero: 19, localizacao: 'bar', posicao_x: 55, posicao_y: 60 },
  { qtd_cadeiras: 1, numero: 1, localizacao: 'bar', posicao_x: 110, posicao_y: 60 },
  { qtd_cadeiras: 1, numero: 14, localizacao: 'bar', posicao_x: 165, posicao_y: 60 },
  { qtd_cadeiras: 1, numero: 2, localizacao: 'bar', posicao_x: 220, posicao_y: 60 },
  { qtd_cadeiras: 1, numero: 15, localizacao: 'bar', posicao_x: 275, posicao_y: 60 },
  { qtd_cadeiras: 1, numero: 3, localizacao: 'bar', posicao_x: 330, posicao_y: 60 },
  { qtd_cadeiras: 1, numero: 16, localizacao: 'bar', posicao_x: 385, posicao_y: 60 },
  { qtd_cadeiras: 1, numero: 24, localizacao: 'bar', posicao_x: 440, posicao_y: 60 },
  // === SALAO (10 mesas — 2 rows x 5) ===
  { qtd_cadeiras: 2, numero: 20, localizacao: 'salao', posicao_x: 70, posicao_y: 195 },
  { qtd_cadeiras: 2, numero: 4, localizacao: 'salao', posicao_x: 170, posicao_y: 195 },
  { qtd_cadeiras: 2, numero: 5, localizacao: 'salao', posicao_x: 270, posicao_y: 195 },
  { qtd_cadeiras: 4, numero: 6, localizacao: 'salao', posicao_x: 370, posicao_y: 195 },
  { qtd_cadeiras: 4, numero: 17, localizacao: 'salao', posicao_x: 470, posicao_y: 195 },
  { qtd_cadeiras: 2, numero: 21, localizacao: 'salao', posicao_x: 70, posicao_y: 300 },
  { qtd_cadeiras: 2, numero: 7, localizacao: 'salao', posicao_x: 170, posicao_y: 300 },
  { qtd_cadeiras: 3, numero: 8, localizacao: 'salao', posicao_x: 270, posicao_y: 300 },
  { qtd_cadeiras: 4, numero: 9, localizacao: 'salao', posicao_x: 370, posicao_y: 300 },
  { qtd_cadeiras: 4, numero: 18, localizacao: 'salao', posicao_x: 470, posicao_y: 300 },
  // === EXTERNA (6 mesas — 1 row) ===
  { qtd_cadeiras: 4, numero: 22, localizacao: 'externa', posicao_x: 70, posicao_y: 475 },
  { qtd_cadeiras: 2, numero: 10, localizacao: 'externa', posicao_x: 150, posicao_y: 475 },
  { qtd_cadeiras: 2, numero: 11, localizacao: 'externa', posicao_x: 230, posicao_y: 475 },
  { qtd_cadeiras: 4, numero: 12, localizacao: 'externa', posicao_x: 310, posicao_y: 475 },
  { qtd_cadeiras: 4, numero: 13, localizacao: 'externa', posicao_x: 390, posicao_y: 475 },
  { qtd_cadeiras: 4, numero: 23, localizacao: 'externa', posicao_x: 470, posicao_y: 475 },
];
...
const produtos = [
  ...
  },
  {
    ...
    categoria: 'Frappés',
    valor_unit: 19,
    imagem: 'https://images.unsplash.com/photo-1515823064-d6e0c04616a7?w=400',
  },
  {
  ...
  },
  {
    ...
    valor_unit: 9,
    imagem:
      'https://images.unsplash.com/photo-1606525437679-05b9193e16e7?w=400',
  },
  {
  ...
  },
  {
    ...
    valor_unit: 12,
    imagem:
      'https://images.unsplash.com/photo-1527515545241-17d2f0f8a2a4?w=400',
  },
  {
    dsc_produto: 'Sanduíche Natural',
    categoria: 'Lanches',
    valor_unit: 14,
    imagem: 'https://images.unsplash.com/photo-1553909489-cd47e0907980?w=400',
  },
  {
  ...
  },
  {
    ...
    categoria: 'Lanches',
    valor_unit: 15,
    imagem: 'https://images.unsplash.com/photo-1555507036-ab1f4038024a?w=400',
  },
  {
  ...
  },
  {
    ...
    valor_unit: 14,
    imagem:
      'https://images.unsplash.com/photo-1624371414361-e670edf4e838?w=400',
  },
...
async function seedProdutos(produtoService: ProdutoService) {
  ...
  for (const data of produtos) {
    const existente = existing.data.find(
      (p) => p.dsc_produto === data.dsc_produto,
    );
    if (existente) {
