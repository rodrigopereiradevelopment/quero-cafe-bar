...
export class AddProfileFields1772700000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE usuarios ADD COLUMN telefone VARCHAR(255)`);
    await queryRunner.query(`ALTER TABLE usuarios ADD COLUMN endereco VARCHAR(255)`);
    await queryRunner.query(`ALTER TABLE usuarios ADD COLUMN data_nascimento VARCHAR(255)`);
    await queryRunner.query(`ALTER TABLE usuarios ADD COLUMN cpf VARCHAR(255)`);
    await queryRunner.query(`ALTER TABLE usuarios ADD COLUMN foto VARCHAR(500)`);
  }
