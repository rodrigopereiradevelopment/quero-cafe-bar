...
This project is indexed by GitNexus as **quero-cafe-bar** (964 symbols, 2207 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
